...
<body>
<body>
<h3 style = "font-family: Impact; font-size:60px; background-color:#0000ff; text-align:center; color:#ffffff;">Enter team name to show all game of that team:</h3>
...
<form align = "center" style = "background-color:#00ffff" action="viewGame.php" method="post">
...
if (isset($_POST['submit'])) 
{
    ...
    $command = '/home/mathursb/public_html/viewGame.exe ' . $TeamName;
